...
upperFunc score =
    case score of
        ...
        _ ->
            Debug.crash "Should not be here"
...
lowerFunc score =
    case score of
        ...
        ThreeOfAKind ->
            Score.calcThreeOfAKind

        FourOfAKind ->
            Score.calcFourOfAKind
        ...
        updateValue values model =
            case values of
                ...
                x :: xs ->
                    updateValue xs
                        { model
                            | dice = updateSingleValue (Tuple.first x) (Tuple.second x) model.dice
                        }
    in
        case msg of
            Roll ->
